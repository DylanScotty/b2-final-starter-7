...
describe "Admin Invoices Index Page" do
  before :each do
    ...
    @bulk_discount = BulkDiscount.create!(quantity: 10, discount: 50, merchant_id: @m1.id)
  ...
  describe 'User Story 8' do
    it 'show total revenue and discounted revenue' do
      expect(page).to have_content("Total Revenue: $30.0")
      expect(page).to have_content("Total Revenue with Applied Discounts: $18.0")
    end
  end
end
